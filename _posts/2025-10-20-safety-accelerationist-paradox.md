...
[^23]: When asked which deals involve double counting, Dario demurred: "I don't I don't I don't know. I don't know anything more than you." Then: "What about the ones who are doing triple counting?... I don't There might be some of that, too."

Translation: the announced compute investments may not materialize as claimed (financial vaporware), but Anthropic is "confident in the company's ability" to secure needed power. The infrastructure requirements are real—gigawatts, millions of chips, massive capital expenditure—but the public accounting is theater.
