...
The anime *Psycho-Pass* depicts the Sibyl System—an AI that governs 22nd-century Japan by measuring citizens' psychological states and preemptively intervening when "crime coefficients" rise {% cite psychopass2012anime %}. The system achieves stability and safety while eliminating free will, turning crime into "a data object and measurable type" subject to algorithmic regulation. The show's philosophical bite: Sibyl is literally a hive mind of human criminals whose psyches can't be measured by its own scans. The "benevolent" governor is the criminally asymptomatic masquerading as omniscient authority.
