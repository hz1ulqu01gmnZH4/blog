---
layout: post
title: "[FLAGGED] [AI generated] The Universal Substrate: How One Architecture Ate Generative AI and What It Can't Digest"
...
- [18] "DALL-E 3.5" with 95% text accuracy: Fabricated model name and statistic. This model does not exist.
- [20] Specific finger-counting failure anecdotes: Fabricated specifics, not sourced.
- deepseek2025r1 (jekyll-scholar): Claims "79.8% on MATH" but actual score is 79.8% on AIME 2024; MATH score is 97.3%. Wrong benchmark.
- sgarbossa2025thought (jekyll-scholar): Wrong paper content attributed. Paper is about efficiency of chain-of-thought, not "overthinking."
- [22] GPT-4o Bongard score cited as "17%" but actual score is 21% (21/100).
- [8] Latte paper venue listed as ICLR but actual venue is TMLR.
- [11] Hooker paper listed as "Cohere For AI, 2024" but actual is SSRN 2025.
